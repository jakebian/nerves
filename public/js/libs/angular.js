/**
 * @license AngularJS v1.2.26-local+sha.628b747
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.26-local+sha.628b747/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.26-local+sha.628b747',    // all of these placeholder strings will be replaced by grunt's
